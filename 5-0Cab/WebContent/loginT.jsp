    ...
    <div class="tab-content" id="pills-tabContent">
      <div class="tab-pane fade show active" id="pills-signin" role="tabpanel" aria-labelledby="pills-signin-tab">
        <div class="col-sm-12 border border-primary shadow rounded pt-2">
          <div class="text-center"><img src="images/Logo.png" class="rounded-circle border p-1" height="45" width="100"></div>
        ...
        <div class="col-sm-12 border border-dark shadow rounded pt-2">
          ...
          <form method="post" id="singnupFrom">
            ...
            <div class="form-group">
              ...
              <div class="text-secondary"><em>Help Cab Driver Identify You!</em></div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label><input type="checkbox" name="signupcondition" id="signupcondition" required> I agree with the <a href="javascript:;">Terms &amp; Conditions</a></label>
            </div>
            <div class="form-group">
