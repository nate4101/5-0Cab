...
<tbody id ="append">
  <tr class="table-success">
    ...
    <td><div class="btn-group"> <i class="dropdown-arrow dropdown-arrow-inverse"></i>
        <button class="btn secondary btn-dark dropdown-toggle" data-toggle="dropdown"> </button>
        <input id="change" form="form1" type="text" name="cab_num" value="5" readonly/>
        <ul class="dropdown-menu dropdown-inverse">
          <li><a href="#" style="color:black;">Demo</a> </li>
          <li><a href="#" style="color:black;">38</a> </li>
        </ul>
      </div></td>
